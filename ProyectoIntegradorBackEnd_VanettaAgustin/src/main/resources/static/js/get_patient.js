window.addEventListener('load', function () {
    ...
    .then(data => {
         ...
         dentistRow.innerHTML = '<td>' + updateButton + '</td>' +
                              ...
                              '<td class=\"td_register\">' + dentist.email.toUpperCase() + '</td>' +
                              '<td class=\"td_register\">' + dentist.dni + '</td>' +
                              '<td class=\"td_register\">' + dentist.initDate + '</td>' +
                              '<td class=\"td_register\">' + dentist.address.street.toUpperCase() + '</td>' +
                              '<td class=\"td_register\">' + dentist.address.number + '</td>' +
                              '<td class=\"td_register\">' + dentist.address.city + '</td>' +
                              '<td>' + deleteButton + '</td>';
